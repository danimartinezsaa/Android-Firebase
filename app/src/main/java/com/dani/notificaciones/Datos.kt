...
data class Datos(var usuario: String, var cafeleche: String, var cafesololargo: String, var croissant: String, var tostada: String, var tortilla: String,var confirmado: Boolean){
    ...
    fun crearHashMapDatos() {
        miHashMapDatos.put("usuario",usuario)
